...
> Este checklist está diseñado para evaluar el cumplimiento de la "Política de Protección del Puesto de Trabajo". Cada control debe ser revisado y evaluado según el estado actual de implementación en la organización. Se pueden añadir o eliminar controles según las necesidades específicas de la organización o política implementada, siempre que estén justificados por los riesgos identificados en el PDS.

### Niveles de Control

- **B (Básico)**: Medidas esenciales - Implementación más sencilla e inmediata
- **A (Avanzado)**: Medidas adicionales - Implementación que conlleva mayor complejidad y recursos
